...
public class MainWindow extends JFrame {
	...
	private MainWindow() {
			...
			public void actionPerformed(ActionEvent e) {
				if(!esFloat(textField.getText())) {
					...
					if(comboBox_1.getSelectedIndex()==0) {
						JOptionPane.showMessageDialog(null, "Debe seleccionar un a�o.");
					}else {
		...
		btnCalcularCae.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(tasascorrectas == true) {
					...
					JOptionPane.showMessageDialog(null, "Todos los a�os deben tener una tasa mayor o igual a 0.");
				}
		...
		comboBox_1.addItem("Seleccione un a�o");
	...
	public void actualizarTabla() {
		...
		for(String key : autos.keySet()) {
			...
			for(int i=0; i<aux.getDuracion();i++) {
				...
				JLabel lblMontoAnual = new JLabel("Costos totales del a�o "+i+": "+costototal+".");
				lblMontoAnual.setBounds(12, 56+21*i, 390, 15);
				panel_2.add(lblMontoAnual);
				
				JLabel lblPrecioReventa = new JLabel("El precio de reventa para el a�o "+i+" es de: "+aux.getPrecioReventa(i)+".");
	...
	private void actualizarTasas() {
		...
		for(int i=0; i<CAE.interesCompuesto.size();i++) {
			if(CAE.comienzo == true) {
				comboBox_1.addItem("A�o "+i+" tasa "+CAE.interesCompuesto.get(i));
			}else {
				comboBox_1.addItem("A�o "+new Integer(i+1)+" tasa "+CAE.interesCompuesto.get(i));
			}
		}
	}
}
